...
{{- end -}}
{{- if not (trim (toString .Values.secretManagerProject)) -}}
{{- fail "secretManagerProject must be set" -}}
{{- end -}}
{{- if not (trim (toString .Values.hcDnsDomains)) -}}
{{- fail "hcDnsDomains must be set" -}}
{{- end -}}
{{- end }}
